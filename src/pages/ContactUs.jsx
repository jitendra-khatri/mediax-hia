                ...
                <div className="container-xxl">
                    <div className="row">
                        <div className="col-md-5 p-0">
                            ...
                            <h3>Get in touch </h3>
                            <p>Have a question or need assistance? Fill out the form below, and we'll get back to you as soon as possible. We're here to help!</p>
                            <ul className="list-unstyled p-0 m-0 d-flex flex-column gap-3 gap-md-4 mt-3 mt-md-5">
                                <li>
                                ...
                                <li>
                                    <a href="tel:+919760273375" target='_blank'>
                                    <span className="con-icon">
                                    <i class="fas fa-phone-alt"></i>
                                    </span>
                                    <span className="con-text">
                                  <p className='m-0'>
                                  <b>Phone:</b>+91 9760273375
                                  </p>
                                    </span>
                                </a>
                                </li>
